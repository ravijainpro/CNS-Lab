...
void ShiftRows_dec(unsigned char * state) {
	unsigned char tmp[16];
 ...
 */
void Round_dec(unsigned char * state, unsigned char * key) {
...
void InitialRound_dec(unsigned char * state, unsigned char * key) {
	SubRoundKey(state, key);
	ShiftRows_dec(state);
	SubBytes(state);
}
...
void AESDecrypt(unsigned char * encryptedMessage, unsigned char * expandedKey, unsigned char * decryptedMessage)
{
	...
	InitialRound_dec(state, expandedKey+160);

	int numberOfRounds = 9;

	for (int i = 8; i >= 0; i--) {
		Round_dec(state, expandedKey + (16 * (i + 1)));
	}
...
int main() {
	...
	cout << "=============================" << endl;
	cout << " AES 128-bit Encryption   " << endl;
	cout << "Key Used: " << str << endl;
	cout << "=============================" << endl << endl;
	...
	cout << "Decrypted Plain Text (In hex): " << endl;
